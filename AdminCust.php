...
<div class="nav"><a href='AdminProd.php'>Product Information</a>| <a href="catalogue/home.php">Logout</a></div>
<div class="picture1">
...
<?php
  ...
  echo "<center>";
   ...
   echo "<table border='1' style='color:white'><tr><th>FirstName</th><th>LastName</th><th>Gender</th><th>LocalAddress</th><th>Username</th>";
	
 while ($row=mysql_fetch_array ($result))
 {
  echo "<tr>";
  echo "<td>".$row['FirstName']."</td>";
  echo "<td><a style='color:#3FF' href='user.php?SID=".$row['UserID']."&action=select'>".$row['LastName']."</a>";
